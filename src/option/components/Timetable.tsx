...
// export class TimeTable extends React.Component<{}, { coursemng: CourseManeger }> {
//     private courses: CourseManeger;
//     private timetable: TimeTableManeger;
//     constructor(props: {}) {
//         super(props);
//         this.courses = new CourseManeger(this.forceUpdate.bind(this, () => { console.log("course maneger") }));
//         this.timetable = new TimeTableManeger(this.forceUpdate.bind(this, () => { console.log("timetable maneger") }));
//     }
//     render() {
//         let table_rows: JSX.Element[] = [];
//         table_rows.push(
...
//                     <th>{period}</th>
//                     {days.map((day) => {
//                         let id = this.timetable.load(day, period);
//                         return <td key={"course-" + day + String(period)}>
//                             {id}<br />
//                             {this.courses.load(id)}
//                         </td>
//                     })}
//                 </tr>
//             );
...
//             maxWidth: "1400px"
//         }
//         const table = <table style={table_style}>
//             <tbody>
//                 {table_rows}
//             </tbody>
//         </table>;
